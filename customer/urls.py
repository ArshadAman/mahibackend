...
urlpatterns = [
    ...
    path('view_cart/', view= views.view_cart, name="view_cart"),
    path('increase_cart_count/<uuid:cart_item_id>/', view=views.increase_cart_count, name='increase_cart_count'),
    path('decrease_cart_count/<uuid:cart_item_id>/', view=views.decrease_cart_count, name='decrease_cart_count'),
    ...
    path('apply-coupon/<str:coupon_code>/', view=views.apply_coupon, name="apply-coupon"),
